...
CREATE TABLE [PREFIX]aliquoteiva ( codice char(3) NOT NULL default '', descrizione varchar(30) default NULL, iva double NOT NULL default '0', reparto char(3) default NULL, PRIMARY KEY  (codice), UNIQUE KEY codice (codice), KEY aliquoteivaiva (iva) ) TYPE=MyISAM;
...
CREATE TABLE [PREFIX]articoloperiodo ( idtable int(11) unsigned NOT NULL default '0', codice varchar(20) default NULL, dalmese int(3) unsigned default '0', almese int(3) unsigned default '0' ) TYPE=MyISAM;
...
CREATE TABLE [PREFIX]catmerceologica ( codice varchar(5) NOT NULL default '', descrizione varchar(50) default NULL, tipo char(2) default NULL, PRIMARY KEY  (codice), UNIQUE KEY codice (codice) ) TYPE=MyISAM;
...
CREATE TABLE [PREFIX]contconti ( codice varchar(4) default NULL, descrizione varchar(50) default NULL, mastro char(1) default NULL ) TYPE=MyISAM;
...
CREATE TABLE [PREFIX]contmastri ( codice char(1) default NULL, descrizione varchar(50) default NULL ) TYPE=MyISAM;
...
CREATE TABLE [PREFIX]contsegno ( codice char(1) default NULL, descrizione varchar(5) default NULL ) TYPE=MyISAM;
...
CREATE TABLE [PREFIX]doccampi ( idtable bigint(20) NOT NULL auto_increment, codtipodoc varchar(5) default NULL, testatarighe char(1) NOT NULL default '', nomecampo varchar(50) default NULL, visible char(1) NOT NULL default '', PRIMARY KEY  (idtable), UNIQUE KEY univoca (codtipodoc,nomecampo,testatarighe) ) TYPE=MyISAM;
...
CREATE TABLE [PREFIX]doccampireport ( idtable int(11) unsigned default NULL, codtipodoc varchar(5) default NULL, campo varchar(30) default '0', nomecampo varchar(30) default NULL, ordine int(10) unsigned default NULL ) TYPE=MyISAM;
...
CREATE TABLE [PREFIX]docregistri ( codice char(2) NOT NULL default '', descrizione varchar(50) default NULL, seriale int(11) default '0', PRIMARY KEY  (codice), UNIQUE KEY codice (codice) ) TYPE=MyISAM;
...
CREATE TABLE [PREFIX]fornitoreperiodo ( idtable int(11) NOT NULL default '0', fornitore varchar(5) default NULL, datainizio date default NULL, datafine date default NULL, chiuso char(1) default NULL, eseguito char(1) default NULL, ricorsivo char(1) default NULL, PRIMARY KEY  (idtable) ) TYPE=MyISAM;
...
CREATE TABLE [PREFIX]giacenza ( codice varchar(20) NOT NULL default '', descrizione varchar(100) default NULL ) TYPE=MyISAM;
...
CREATE TABLE [PREFIX]movmagcausali ( codice varchar(5) NOT NULL default '', descrizione varchar(50) default NULL, carscar char(1) default NULL, PRIMARY KEY  (codice), KEY codice (codice) ) TYPE=MyISAM;
...
CREATE TABLE [PREFIX]pagamenti ( codice varchar(15) NOT NULL default '0', descrizione varchar(40) default NULL, PRIMARY KEY  (codice) ) TYPE=MyISAM;
...
CREATE TABLE [PREFIX]progetti ( codice varchar(10) default NULL, descrizione varchar(50) default NULL, centrale varchar(15) default NULL, ordine int(11) default '10' ) TYPE=MyISAM;
...
CREATE TABLE [PREFIX]referenti ( idtable int(3) default NULL, codanag varchar(5) default NULL, codfornitore varchar(5) default NULL ) TYPE=MyISAM;
...
CREATE TABLE [PREFIX]tipiarticoli ( codice char(2) NOT NULL default '', descrizione varchar(50) default NULL, PRIMARY KEY  (codice), UNIQUE KEY codice (codice) ) TYPE=MyISAM;
...
CREATE TABLE [PREFIX]tipimovcon ( idtipo char(8) default NULL, descrizione char(15) default NULL, UNIQUE KEY descrizione (descrizione), UNIQUE KEY idtipo (idtipo) ) TYPE=MyISAM;
...
CREATE TABLE [PREFIX]tipoanagrafiche ( codice char(1) NOT NULL default '', descrizione varchar(20) default NULL, UNIQUE KEY codice (codice) ) TYPE=MyISAM;
...
CREATE TABLE [PREFIX]tipofatnac ( codice char(1) NOT NULL default '', descrizione varchar(15) default NULL, PRIMARY KEY  (codice) ) TYPE=MyISAM;
...
CREATE TABLE [PREFIX]tipostato ( codice char(1) default NULL, descrizione varchar(15) default NULL ) TYPE=MyISAM;
...
CREATE TABLE [PREFIX]um ( codice varchar(10) default NULL, desc_singolare varchar(30) default NULL, desc_plurale varchar(30) default NULL, genere varchar(30) NOT NULL, ordine int(11) default NULL, UNIQUE KEY codice (codice) ) TYPE=MyISAM;
